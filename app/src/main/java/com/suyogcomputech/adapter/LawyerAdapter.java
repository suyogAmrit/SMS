 ...
 */
public class LawyerAdapter extends RecyclerView.Adapter<LawyerAdapter.ShowTariffsViewHolder> {
    List<Doctor> myItems;
    Context myContext;
    ...
    public LawyerAdapter(List<Doctor> myItems, Context myContext) {
    ...
    @Override
    public LawyerAdapter.ShowTariffsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_lawyer, null);
        LawyerAdapter.ShowTariffsViewHolder holder = new LawyerAdapter.ShowTariffsViewHolder(v);

        return holder;
    }

    @Override
    public void onBindViewHolder(LawyerAdapter.ShowTariffsViewHolder holder, int position) {
