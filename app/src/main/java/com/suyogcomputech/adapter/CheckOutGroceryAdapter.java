 ...
 */
//public class CheckOutGroceryAdapter extends {
//}
...
public class CheckOutGroceryAdapter extends RecyclerView.Adapter<CheckOutGroceryAdapter.ViewHolder> {
    int width, height;
    String uniqueUserId;
    Context context;
    ArrayList<GroceryCartList> cartArrayLists;

    public CheckOutGroceryAdapter(Context c, ArrayList<GroceryCartList> cartArrayList) {
        context = c;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.grocery_checkout_adapter, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        price=Float.valueOf(cartlists.getPrice());
        qty=Float.valueOf(cartlists.getQuantity().toString());
        total=price*qty;
        holder.tv_grand_total.setText(String.valueOf(total));
...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView title, price, quantity,tv_grand_total;
...
//            product_image=(ImageView)itemView.findViewById(R.id.prod_image);
            ...
            tv_grand_total=(TextView)itemView.findViewById(R.id.tv_grand_total);
